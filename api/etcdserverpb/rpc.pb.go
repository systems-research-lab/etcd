...
type MemberSplitRequest struct {
	// IDs of nodes to split from the cluster
	Clusters []MemberList `protobuf:"bytes,1,rep,name=clusters,proto3" json:"clusters"`
	// ExplicitLeave tells whether nodes should leave the joint consensus automatically when safe
	ExplicitLeave bool `protobuf:"varint,2,opt,name=ExplicitLeave,proto3" json:"ExplicitLeave,omitempty"`
	// Leave explicitly tells the cluster in joint consensus to leave
...
func (m *MemberSplitRequest) Reset()         { *m = MemberSplitRequest{} }
func (m *MemberSplitRequest) String() string { return proto.CompactTextString(m) }
func (*MemberSplitRequest) ProtoMessage()    {}
func (*MemberSplitRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_77a6da22d6a3feb1, []int{51}
}
func (m *MemberSplitRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MemberSplitRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MemberSplitRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MemberSplitRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MemberSplitRequest.Merge(m, src)
}
func (m *MemberSplitRequest) XXX_Size() int {
	return m.Size()
}
func (m *MemberSplitRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_MemberSplitRequest.DiscardUnknown(m)
}

var xxx_messageInfo_MemberSplitRequest proto.InternalMessageInfo

func (m *MemberSplitRequest) GetClusters() []MemberList {
	if m != nil {
		return m.Clusters
	}
	return nil
...
func (m *MemberSplitRequest) GetExplicitLeave() bool {
	if m != nil {
		return m.ExplicitLeave
	}
	return false
}

func (m *MemberSplitRequest) GetLeave() bool {
	if m != nil {
		return m.Leave
	}
	return false
...
type MemberSplitResponse struct {
	Header               *ResponseHeader `protobuf:"bytes,1,opt,name=header,proto3" json:"header,omitempty"`
...
func (m *MemberSplitResponse) Reset()         { *m = MemberSplitResponse{} }
func (m *MemberSplitResponse) String() string { return proto.CompactTextString(m) }
func (*MemberSplitResponse) ProtoMessage()    {}
func (*MemberSplitResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_77a6da22d6a3feb1, []int{52}
}
func (m *MemberSplitResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MemberSplitResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MemberSplitResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MemberSplitResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MemberSplitResponse.Merge(m, src)
}
func (m *MemberSplitResponse) XXX_Size() int {
	return m.Size()
}
func (m *MemberSplitResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_MemberSplitResponse.DiscardUnknown(m)
}

var xxx_messageInfo_MemberSplitResponse proto.InternalMessageInfo

func (m *MemberSplitResponse) GetHeader() *ResponseHeader {
	if m != nil {
		return m.Header
	}
	return nil
...
func (m *MemberSplitResponse) GetMembers() []Member {
	if m != nil {
		return m.Members
	}
	return nil
...
type MemberMergeRequest struct {
	// clusters mapping from cluster id to a member
	Clusters             map[uint64]MemberList `protobuf:"bytes,1,rep,name=clusters,proto3" json:"clusters" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	XXX_NoUnkeyedLiteral struct{}              `json:"-"`
	XXX_unrecognized     []byte                `json:"-"`
	XXX_sizecache        int32                 `json:"-"`
}
...
func (m *MemberMergeRequest) GetClusters() map[uint64]MemberList {
	if m != nil {
		return m.Clusters
	}
	return nil
...
func (m *MemberMergeResponse) GetHeader() *ResponseHeader {
	if m != nil {
		return m.Header
	}
	return nil
...
func (m *MemberMergeResponse) GetMembers() []Member {
	if m != nil {
		return m.Members
	}
	return nil
...
type MemberJointRequest struct {
	AddPeersUrl          []string `protobuf:"bytes,1,rep,name=addPeersUrl,proto3" json:"addPeersUrl,omitempty"`
	RemovePeersId        []uint64 `protobuf:"varint,2,rep,packed,name=removePeersId,proto3" json:"removePeersId,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *MemberJointRequest) Reset()         { *m = MemberJointRequest{} }
func (m *MemberJointRequest) String() string { return proto.CompactTextString(m) }
func (*MemberJointRequest) ProtoMessage()    {}
func (*MemberJointRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_77a6da22d6a3feb1, []int{55}
}
func (m *MemberJointRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MemberJointRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MemberJointRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MemberJointRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MemberJointRequest.Merge(m, src)
}
func (m *MemberJointRequest) XXX_Size() int {
	return m.Size()
}
func (m *MemberJointRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_MemberJointRequest.DiscardUnknown(m)
}

var xxx_messageInfo_MemberJointRequest proto.InternalMessageInfo

func (m *MemberJointRequest) GetAddPeersUrl() []string {
	if m != nil {
...
func (m *MemberJointRequest) GetRemovePeersId() []uint64 {
	if m != nil {
		return m.RemovePeersId
	}
	return nil
}

type MemberJointResponse struct {
	Header               *ResponseHeader `protobuf:"bytes,1,opt,name=header,proto3" json:"header,omitempty"`
	Members              []*Member       `protobuf:"bytes,2,rep,name=members,proto3" json:"members,omitempty"`
	XXX_NoUnkeyedLiteral struct{}        `json:"-"`
	XXX_unrecognized     []byte          `json:"-"`
...
func (m *MemberJointResponse) Reset()         { *m = MemberJointResponse{} }
func (m *MemberJointResponse) String() string { return proto.CompactTextString(m) }
func (*MemberJointResponse) ProtoMessage()    {}
func (*MemberJointResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_77a6da22d6a3feb1, []int{56}
}
func (m *MemberJointResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MemberJointResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MemberJointResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MemberJointResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MemberJointResponse.Merge(m, src)
}
func (m *MemberJointResponse) XXX_Size() int {
	return m.Size()
}
func (m *MemberJointResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_MemberJointResponse.DiscardUnknown(m)
}

var xxx_messageInfo_MemberJointResponse proto.InternalMessageInfo

func (m *MemberJointResponse) GetHeader() *ResponseHeader {
	if m != nil {
		return m.Header
	}
	return nil
...
func (m *MemberJointResponse) GetMembers() []*Member {
	if m != nil {
		return m.Members
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*MemberList)(nil), "etcdserverpb.MemberList")
	proto.RegisterType((*MemberSplitRequest)(nil), "etcdserverpb.MemberSplitRequest")
	proto.RegisterType((*MemberSplitResponse)(nil), "etcdserverpb.MemberSplitResponse")
	proto.RegisterType((*MemberMergeRequest)(nil), "etcdserverpb.MemberMergeRequest")
	proto.RegisterMapType((map[uint64]MemberList)(nil), "etcdserverpb.MemberMergeRequest.ClustersEntry")
	proto.RegisterType((*MemberMergeResponse)(nil), "etcdserverpb.MemberMergeResponse")
	proto.RegisterType((*MemberJointRequest)(nil), "etcdserverpb.MemberJointRequest")
	proto.RegisterType((*MemberJointResponse)(nil), "etcdserverpb.MemberJointResponse")
...
var fileDescriptor_77a6da22d6a3feb1 = []byte{
	...
	,
}
...
type KVClient interface {
	...
	// A put request increments the revision of the key-value store
	// and generates one event in the event history.
	PutP(ctx context.Context, in *PutRequest, opts ...grpc.CallOption) (*PutResponse, error)
...
func (c *kVClient) PutP(ctx context.Context, in *PutRequest, opts ...grpc.CallOption) (*PutResponse, error) {
	out := new(PutResponse)
	err := c.cc.Invoke(ctx, "/etcdserverpb.KV/PutP", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type KVServer interface {
	...
	// A put request increments the revision of the key-value store
	// and generates one event in the event history.
	PutP(context.Context, *PutRequest) (*PutResponse, error)
	// DeleteRange deletes the given range from the key-value store.
	// A delete request increments the revision of the key-value store
	// and generates a delete event in the event history for every deleted key.
...
func (*UnimplementedKVServer) PutP(ctx context.Context, req *PutRequest) (*PutResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PutP not implemented")
}
...
func _KV_PutP_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PutRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(KVServer).PutP(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/etcdserverpb.KV/PutP",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(KVServer).PutP(ctx, req.(*PutRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
type ClusterClient interface {
	...
	MemberSplit(ctx context.Context, in *MemberSplitRequest, opts ...grpc.CallOption) (*MemberSplitResponse, error)
	MemberMerge(ctx context.Context, in *MemberMergeRequest, opts ...grpc.CallOption) (*MemberMergeResponse, error)
	MemberJoint(ctx context.Context, in *MemberJointRequest, opts ...grpc.CallOption) (*MemberJointResponse, error)
}
...
func (c *clusterClient) MemberSplit(ctx context.Context, in *MemberSplitRequest, opts ...grpc.CallOption) (*MemberSplitResponse, error) {
	out := new(MemberSplitResponse)
	err := c.cc.Invoke(ctx, "/etcdserverpb.Cluster/MemberSplit", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *clusterClient) MemberMerge(ctx context.Context, in *MemberMergeRequest, opts ...grpc.CallOption) (*MemberMergeResponse, error) {
	out := new(MemberMergeResponse)
	fmt.Println("MemberMerge")
	err := c.cc.Invoke(ctx, "/etcdserverpb.Cluster/MemberMerge", in, out, opts...)
	if err != nil {
		fmt.Println("MemberMerge err")
		return nil, err
	}
	return out, nil
}

func (c *clusterClient) MemberJoint(ctx context.Context, in *MemberJointRequest, opts ...grpc.CallOption) (*MemberJointResponse, error) {
	out := new(MemberJointResponse)
	err := c.cc.Invoke(ctx, "/etcdserverpb.Cluster/MemberJoint", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ClusterServer interface {
	...
	MemberSplit(context.Context, *MemberSplitRequest) (*MemberSplitResponse, error)
	MemberMerge(context.Context, *MemberMergeRequest) (*MemberMergeResponse, error)
	MemberJoint(context.Context, *MemberJointRequest) (*MemberJointResponse, error)
}
...
func (*UnimplementedClusterServer) MemberSplit(ctx context.Context, req *MemberSplitRequest) (*MemberSplitResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method MemberSplit not implemented")
}
func (*UnimplementedClusterServer) MemberMerge(ctx context.Context, req *MemberMergeRequest) (*MemberMergeResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method MemberMerge not implemented")
}
func (*UnimplementedClusterServer) MemberJoint(ctx context.Context, req *MemberJointRequest) (*MemberJointResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method MemberJoint not implemented")
}
...
func _Cluster_MemberSplit_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(MemberSplitRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ClusterServer).MemberSplit(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/etcdserverpb.Cluster/MemberSplit",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClusterServer).MemberSplit(ctx, req.(*MemberSplitRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Cluster_MemberMerge_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(MemberMergeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ClusterServer).MemberMerge(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/etcdserverpb.Cluster/MemberMerge",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClusterServer).MemberMerge(ctx, req.(*MemberMergeRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Cluster_MemberJoint_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(MemberJointRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ClusterServer).MemberJoint(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/etcdserverpb.Cluster/MemberJoint",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClusterServer).MemberJoint(ctx, req.(*MemberJointRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Cluster_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "MemberSplit",
			Handler:    _Cluster_MemberSplit_Handler,
		},
		{
			MethodName: "MemberMerge",
			Handler:    _Cluster_MemberMerge_Handler,
		},
		{
			MethodName: "MemberJoint",
			Handler:    _Cluster_MemberJoint_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "rpc.proto",
...
func (m *MemberSplitRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MemberSplitRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MemberSplitRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *MemberSplitResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MemberSplitResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MemberSplitResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *MemberMergeRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MemberMergeRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MemberMergeRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.Clusters) > 0 {
		for k := range m.Clusters {
			...
			i--
			dAtA[i] = 0x12
			i = encodeVarintRpc(dAtA, i, uint64(k))
			i--
			dAtA[i] = 0x8
...
func (m *MemberMergeResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MemberMergeResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MemberMergeResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *MemberJointRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MemberJointRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MemberJointRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.RemovePeersId) > 0 {
		dAtA40 := make([]byte, len(m.RemovePeersId)*10)
		var j39 int
		for _, num := range m.RemovePeersId {
			for num >= 1<<7 {
	...
	if len(m.AddPeersUrl) > 0 {
		for iNdEx := len(m.AddPeersUrl) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.AddPeersUrl[iNdEx])
			copy(dAtA[i:], m.AddPeersUrl[iNdEx])
			i = encodeVarintRpc(dAtA, i, uint64(len(m.AddPeersUrl[iNdEx])))
			i--
			dAtA[i] = 0xa
		}
	}
...
func (m *MemberJointResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MemberJointResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MemberJointResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *MemberSplitRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MemberSplitResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MemberMergeRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if len(m.Clusters) > 0 {
		for k, v := range m.Clusters {
			...
			_ = v
			l = v.Size()
			mapEntrySize := 1 + sovRpc(uint64(k)) + 1 + l + sovRpc(uint64(l))
...
func (m *MemberMergeResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MemberJointRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MemberJointResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MemberSplitRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MemberSplitRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MemberSplitRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.Clusters = append(m.Clusters, MemberList{})
		...
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ExplicitLeave", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
func (m *MemberSplitResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MemberSplitResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MemberSplitResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *MemberMergeRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MemberMergeRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MemberMergeRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			if m.Clusters == nil {
				m.Clusters = make(map[uint64]MemberList)
			}
			var mapkey uint64
			mapvalue := &MemberList{}
			for iNdEx < postIndex {
...
func (m *MemberMergeResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MemberMergeResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MemberMergeResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *MemberJointRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MemberJointRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MemberJointRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AddPeersUrl", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.AddPeersUrl = append(m.AddPeersUrl, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		case 2:
			if wireType == 0 {
				var v uint64
				...
				m.RemovePeersId = append(m.RemovePeersId, v)
			} else if wireType == 2 {
				var packedLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				elementCount = count
				if elementCount != 0 && len(m.RemovePeersId) == 0 {
					m.RemovePeersId = make([]uint64, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v uint64
					for shift := uint(0); ; shift += 7 {
				...
				return fmt.Errorf("proto: wrong wireType = %d for field RemovePeersId", wireType)
			}
		default:
			iNdEx = preIndex
			skippy, err := skipRpc(dAtA[iNdEx:])
...
func (m *MemberJointResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MemberJointResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MemberJointResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
